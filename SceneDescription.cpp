...
namespace scene_description
{
        ...
        SceneMesh::SceneMesh(std::vector<glm::vec3> vertices, std::vector<glm::vec3> normals,
        ...
        SceneMaterial::SceneMaterial(const glm::vec3 &color, float shininess, float specularStrength, float diffuseStrength,
                                     const std::optional<unsigned int> &albedoTextureIndex,
                                     const std::optional<unsigned int> &normalTextureIndex) : color(color), shininess(shininess),
        ...
        SceneDescription::SceneDescription(std::vector<SceneMesh> meshes, std::vector<png::image<png::rgb_pixel>> textures,

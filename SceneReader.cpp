...
{
    std::optional<scene_description::SceneDescription> readScene(const std::string &scenePath)
    {
        // read a JSON file
        ...
        try
        {
            ...
            // Store the textures
            std::vector<png::image<png::rgb_pixel>> textures_vector;
            textures_vector.reserve(textures.size()); // TODO: Use std tranform to load textures into vector
